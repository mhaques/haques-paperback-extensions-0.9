...
var source = (() => {
    ...
    "node_modules/buffer/index.js"(exports) {
      ...
      function arrayIndexOf(arr, val2, byteOffset, encoding, dir) {
        ...
        if (dir) {
          ...
          for (i = byteOffset; i < arrLength; i++) {
            if (
              read(arr, i) ===
              read(val2, foundIndex === -1 ? 0 : i - foundIndex)
            ) {
      ...
      Buffer3.prototype.fill = function fill(val2, start, end2, encoding) {
        ...
        if (typeof val2 === "number") {
          ...
          const bytes = Buffer3.isBuffer(val2)
            ? val2
            : Buffer3.from(val2, encoding);
          const len = bytes.length;
          if (len === 0) {
            throw new TypeError(
              'The value "' + val2 + '" is invalid for argument "value"',
            );
          }
        ...
        async incrementRequestCount() {
          ...
          if (this.currentRequestsMade >= this.options.numberOfRequests) {
            ...
            if (secondsSinceLastReset2 <= this.options.bufferInterval) {
              const sleepTime =
                this.options.bufferInterval - secondsSinceLastReset2;
              console.log(
  ...
  var require_CloudflareError = __commonJS({
    "node_modules/@paperback/types/lib/impl/CloudflareError.js"(exports) {
      ...
      var CloudflareError2 = class extends Error {
        ...
        constructor(
          resolutionRequest,
          message = "Cloudflare bypass is required",
        ) {
          super(message);
    ...
    "node_modules/@paperback/types/lib/impl/URL.js"(exports) {
      ...
      function parseURL(url) {
        ...
        if (match[2] !== void 0 && match[2] !== "") {
          ...
          if (hostPort !== "") {
            if (hostPort.startsWith("[")) {
              ...
              components.hostname = hostPort.substring(
                0,
        ...
        if (match[3] !== void 0 && match[3] !== "") {
          components.path = match[3].startsWith("/")
            ? match[3]
            : `/${match[3]}`;
        }
        if (match[4] !== void 0) {
      ...
      var URL2 = class {
         ...
         */
        setPath(newPathname) {
          this.path = newPathname.startsWith("/")
            ? newPathname
            : `/${newPathname}`;
          return this;
        }
  ...
  var require_DiscoverSectionType = __commonJS({
    "node_modules/@paperback/types/lib/DiscoverSectionType.js"(exports) {
      ...
      (function (DiscoverSectionType3) {
        DiscoverSectionType3[(DiscoverSectionType3["featured"] = 0)] =
          "featured";
        DiscoverSectionType3[(DiscoverSectionType3["simpleCarousel"] = 1)] =
          "simpleCarousel";
        DiscoverSectionType3[(DiscoverSectionType3["prominentCarousel"] = 2)] =
          "prominentCarousel";
        DiscoverSectionType3[(DiscoverSectionType3["chapterUpdates"] = 3)] =
          "chapterUpdates";
        DiscoverSectionType3[(DiscoverSectionType3["genres"] = 4)] = "genres";
      })(
        DiscoverSectionType2 ||
          (exports.DiscoverSectionType = DiscoverSectionType2 = {}),
      );
    },
  });
  ...
  var require_SourceInfo = __commonJS({
    "node_modules/@paperback/types/lib/SourceInfo.js"(exports) {
      ...
      (function (SourceIntents2) {
        SourceIntents2[(SourceIntents2["MANGA_CHAPTERS"] = 1)] =
          "MANGA_CHAPTERS";
        SourceIntents2[(SourceIntents2["MANGA_TRACKING"] = 2)] =
          "MANGA_TRACKING";
        SourceIntents2[(SourceIntents2["MANGA_PROGRESS"] = 2)] =
          "MANGA_PROGRESS";
        SourceIntents2[(SourceIntents2["HOMEPAGE_SECTIONS"] = 4)] =
          "HOMEPAGE_SECTIONS";
        SourceIntents2[(SourceIntents2["DISCOVER_SECIONS"] = 4)] =
          "DISCOVER_SECIONS";
        SourceIntents2[(SourceIntents2["COLLECTION_MANAGEMENT"] = 8)] =
          "COLLECTION_MANAGEMENT";
        SourceIntents2[(SourceIntents2["CLOUDFLARE_BYPASS_REQUIRED"] = 16)] =
  ...
  __export(main_exports, {
    Kaynscan: () => Kaynscan,
    KaynscanExtension: () => KaynscanExtension,
  });
  init_buffer();
  ...
  // src/Kaynscan/KaynscanInterceptor.ts
  init_buffer();
      ...
      if (response.status >= 300 && response.status < 400) {
        ...
        if (location && location.startsWith("http://")) {
          ...
          const [newResponse, newData] =
            await Application.scheduleRequest(redirectRequest);
          return newData;
        }
      }
      return data2;
  ...
  var KaynscanExtension = class {
    ...
    async getDiscoverSectionItems(section, metadata) {
      ...
      const hasNextPage =
        $2(".pagination .next, .next-page, a[rel='next']").length > 0;
      return {
        items,
    ...
    async getMangaDetails(mangaId) {
      ...
      if (!image) {
        const imgSrc = $2("img[src*='cdn.meowing'], img[src*='wsrv.nl']")
          .first()
          .attr("src");
      ...
      if (!description) {
        description = $2("p.pre-wrap, div.description p, .synopsis p")
          .first()
          .text()
          .trim();
      }
            ...
            switch (unit) {
              ...
              case "day":
                publishDate = new Date(
                  now.getTime() - value * 24 * 60 * 60 * 1e3,
                );
                break;
              case "week":
                publishDate = new Date(
                  now.getTime() - value * 7 * 24 * 60 * 60 * 1e3,
                );
                break;
              case "month":
                publishDate = new Date(
                  now.getTime() - value * 30 * 24 * 60 * 60 * 1e3,
                );
                break;
              case "year":
                publishDate = new Date(
                  now.getTime() - value * 365 * 24 * 60 * 60 * 1e3,
                );
                break;
            }
          }
  ...
  var Kaynscan = new KaynscanExtension();
